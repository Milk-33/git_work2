...
<html lang="en">
  ...
  <body class="p-3 m-0 border-0 bd-example m-0 border-0">
    ...
    <form class="row g-3 needs-validation was-validated" novalidate="" method="post" action="mm.php">
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        ...
        <div class="input-group has-validation">
          ...
          <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required="" name="numH">
      ...
      <div class="col-md-3">
        ...
        <select class="form-select" id="validationCustom04" required="" name="pro">
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="validationCustom05" required="" name="pass">
        <div class="invalid-feedback">
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="validationCustom05" required="" name="phoneNum">
        <div class="invalid-feedback">
          Please provide a valid zip.
        </div>
      </div>
...
<!--------------------------------------------------------- TO --------------------------------------------------------->
    ...
    <center><h1>ชื่อผู้รับ</h1></center>
      ...
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="validationCustom02"  required="" name="Lname2">
        <div class="valid-feedback">
          Looks good!
        </div>
      </div>
      <div class="col-md-4">
        ...
        <div class="input-group has-validation">
          <span class="input-group-text" id="inputGroupPrepend">@</span>
          <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required="" name="numH2">
          <div class="invalid-feedback">
            Please choose a username.
          </div>
        </div>
      ...
      <div class="col-md-3">
        <label for="validationCustom05" class="form-label">รหัสไปรษณีย์</label>
        <input type="text" class="form-control" id="validationCustom05" required="" name="pass2">
        <div class="invalid-feedback">
          Please provide a valid zip.
        </div>
      </div>
      <div class="col-md-3">
        <label for="validationCustom05" class="form-label">เบอร์โทร</label>
        <input type="text" class="form-control" id="validationCustom05" required="" name="phoneNum2">
        <div class="invalid-feedback">
          Please provide a valid zip.
        </div>
      </div>
      ...
      <div class="col-12">
        <button class="btn btn-primary" type="submit" name="sum">Submit form</button>
        <!-- <a class="btn btn-danger" href="" role="button">Back</a> -->
      </div>
      </form>
  </body>
</html>